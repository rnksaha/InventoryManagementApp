            ...
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                    ...
                    <a class="nav-link px-3" onclick="checkCartStatus()">
                        ...
                        <span id="result"></span></span><span>&nbsp;</span>| View Cart
                                    ...
                                    <c:forEach items="${requestScope.products}" var="product">
                                        <tr>
                                            ...
                                            <td><c:out value="${product.getAvailability()}"></c:out></td>
                                                <td>
                                                    <input type="number" min="1" oninput="this.value=Math.abs(this.value)" max="${product.getAvailability()}" id='Quantity_<c:out value="${product.getProductId()}"/>' value="">
                                            </td>
                                            <td>
